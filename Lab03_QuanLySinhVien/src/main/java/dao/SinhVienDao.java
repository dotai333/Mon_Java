...
public class SinhVienDao {
    ...
    public List<SinhVien> findAll() throws SQLException {
        ...
        try (Connection conn = DBConection.getConnection(); PreparedStatement ps = conn.prepareStatement(sq1); ResultSet rs = ps.executeQuery()) {
            while (rs.next()) {
    ...
    public boolean delete(String maSV) {
        String sq1 = "DELETE FROM SINHVIEN WHERE MaSV=?";

        try (Connection conn = DBConection.getConnection(); PreparedStatement ps = conn.prepareStatement(sq1)) {
    ...
    public SinhVien findById(String maSV) throws SQLException {
        String sq1 = "SELECT * FROM SINHVIEN WHERE MaSV=?";
    ...
    public boolean insert(SinhVien sv){
        String sq1 = "INSERT INTO SINHVIEN VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public boolean update(SinhVien sv){
        String sq1 = "UPDATE SINHVIEN SET HoTen = ?, NgaySinh = ?, GioiTinh = ?, DiaChi = ?, MaKhoa = ? WHERE MaSV = ?";
    ...
    public List<SinhVien> findByName(String name) {
        List<SinhVien> ds = new ArrayList<>();
        String sq1 = "SELECT * FROM SINHVIEN WHERE HoTen LIKE ?";
